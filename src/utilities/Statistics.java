...
public class Statistics {
	...
	public static void highestSkipToPlayRatio(HashMap<Integer, MusicFile> collection) {
		...
		try {
			BufferedWriter outStream = new BufferedWriter(new FileWriter("statistics/Skip to Play Ratio.txt"));
			int i = 1;
	...
	public static void totalTimePerSong(HashMap<Integer, MusicFile> collection) {
		...
		try {
			BufferedWriter outStream = new BufferedWriter(new FileWriter("statistics/Total Time Per Song.txt"));
			int i = 1;
			for (MusicFile song : songList) {
	...
	public static void totalTimePerArtist(HashMap<Integer, MusicFile> collection) {
		...
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("statistics/Total Time Per Artist.txt"));
			int i = 1;
	...
	public static void totalTimePerAlbum(HashMap<Integer, MusicFile> collection) {
		...
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("statistics/Total Time Per Album.txt"));
			int i = 1;
	...
	public static void totalTimePerGenre(HashMap<Integer, MusicFile> collection) {
		...
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("statistics/Total Time Per Genre.txt"));
			int i = 1;
